...
export default function TestDetails(){
  ...
  return (<div className="panel panel--white">
    <h2 className="heading-tertiary--biger u-center-text u-margin-bottom-intermediate">Nivelele de cunoaștere a limbii germane</h2>
    {
