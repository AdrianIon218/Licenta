...
function AboutSection(){
  return (<section className="section-about section-between u_move_up--big">
    ...
    <div className="flex-row">
      <div className="col-1-of-2-text">
        ...
        <a href="#section-course-id" className="btn-text">Vezi cursurile disponibile &nbsp;<i className="fas fa-arrow-right" /></a>
      </div>
