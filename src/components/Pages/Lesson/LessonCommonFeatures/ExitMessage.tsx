...
function ExitMessage(props: LocProps) {
  ...
  return (
    <div
      className={`exit_message__blackdrop ${
        closeMessage && "exit_message__blackdrop--close"
      }`}
    >
      <div className="exit_message__box flex-column--centered">
        <div className="btn_exit_ctn">
          <div className="btn_exit" onClick={closeMessageHandler}>
            {" "}
            &times;{" "}
          </div>
        </div>
        ...
        <div className="flex-row--centered">
          <div className="btn btn--white lesson-btn" onClick={closeLesson}>
            {" "}
            Da{" "}
          </div>
          <div
            className="btn btn--blue lesson-btn"
