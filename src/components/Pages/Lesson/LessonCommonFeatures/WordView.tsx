  ...
  return (
    <div className="flex-column--centered word__container" ref={wordDiv}>
      ...
      <div className="arrow-ctn">
        {props.previousWord !== undefined && (
          <i
            className="fas fa-chevron-circle-left"
            onClick={() => clickHandler(props.previousWord!)}
          />
        )}
        {props.nextWord !== undefined && (
          <i
            className="fas fa-chevron-circle-right arrow-right"
            onClick={() => clickHandler(props.nextWord!)}
          />
        )}
      </div>
    </div>
