  ...
  return (
    ...
    <section className='lesson-section'>
      <div className="lesson-ctn">
        {lessonInfo.lessonId >= 0 && <LessonController {...lessonInfo} 
        setProgressBar={(progressStatus:number)=>setProgressBar(progressStatus)} triggerTransition={triggerTransition} />}
