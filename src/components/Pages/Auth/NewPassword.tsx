...
function NewPassword() {
    ...
    const onSubmit = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>)=>{
        ...
        axios.post("http://localhost:5000/login/changePassword", { email: email, password:password }).then(
           (response)=>{
            ...
            if(status){
               ...
               setNotification({isShown:true, messsage:'Parolă salvată!',type:NotificationType.SUCCESS});
            }else{
    ...
    return (<>{ notification.isShown && <Notification message={notification.messsage} type={notification.type} 
          ...
          <form className="forn">
            <div className="u-center-text u-margin-bottom-medium">
              <h2 className="heading-secondary" style={{textTransform:'none'}}>
                {isPassSaved ? "Parola a fost salvată!":"Setează o parolă nouă!"}
              </h2>
            </div>  
            <div className="form__group" hidden={isPassSaved}>
              ...
              <div className="form__group form__group__checkbox">
                ...
                <input type="checkbox" className="form__checkbox" name="pass_toggle" id="pass_toggle" onClick={togglePassVisibility}/> 
              </div>
            </div>
