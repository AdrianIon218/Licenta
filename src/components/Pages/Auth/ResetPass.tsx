...
function ResetPass() {
  ...
  const serverError = ()=>{
    ...
    setNotification({isShown:true,message: 'Eroare de server ! Încercați mai târziu!', type:NotificationType.ERROR });
  }
          ...
          <div className="box-mountain-bg__form">  
            ...
            <form onSubmit={onSubmit} className="forn">
              ...
              <div className="form__group">
                <input type="email" className="form__input" placeholder="Adresă de email *" id="email" name="email" ref={emailRef} required disabled={disableForm} />
